...
} else {$("#ardoraQuest").html(vHtml+"<img alt='Play' id='playSound' class='imaLeft' src='20OF-Electricidad-Eso3-01-c_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
